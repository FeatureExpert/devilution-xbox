...
#define res_type(ch1, ch2, ch3, ch4) (((unsigned long)(unsigned char)(ch1) << 24) | ((unsigned long)(unsigned char)(ch2) << 16) | ((unsigned long)(unsigned char)(ch3) << 8) | ((unsigned long)(unsigned char)(ch4)))
